...
Appendix :ref:`sec_list-of-gkv-namelist`.

Users may diagnose these output data by themselves. The present version
of GKV provides two post-processing tools, ``gkvfig`` and ``diag_python`` on `GKV GitHub page <https://github.com/GKV-developers>`__.

.. _sec_pdf-generating-script-for-ascii-output-fig_stdout:

gkvfig - Generating PDF of GKV standard ASCII output
------------------------------------------------------------
...
.. _sec_post-processing-program-for-binary-output-diag:

diag_python - Post-processing tool for BINARY output
------------------------------------------------------------
...
For more details,
Appendix :ref:`sec_diagnostics-modules-in-the-post-processing-program-diag`
