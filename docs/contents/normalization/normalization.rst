...
-   Reference magnetic field strength :math:`B_\mathrm{ref}` (:math:`=B_a` magnetic
    field strength at the magnetic axis)

-   Reference length :math:`L_\mathrm{ref}` (:math:`=R_a` major radius at the
    magnetic axis)

-   Reference density :math:`n_\mathrm{ref}` (:math:`=n_e(\rho_0)` electron density
    at the center of flux-tube domain)

-   Reference temperature :math:`T_\mathrm{ref}` (:math:`=T_i(\rho_0)` main ion
    temperature at the center of flux-tube domain)

-   Reference mass :math:`m_\mathrm{ref}` (:math:`=m_\mathrm{p}` the proton mass)

-   Reference electric charge :math:`e_\mathrm{ref}` (:math:`=e` elementary charge)

We also define the following notations
:math:`v_\mathrm{ref} = \sqrt{T_\mathrm{ref} / m_\mathrm{ref}}`,
:math:`\rho_\mathrm{ref} = m_\mathrm{ref} v_\mathrm{ref} / (e_\mathrm{ref} B_\mathrm{ref})`,
:math:`\delta_\mathrm{ref} = \rho_\mathrm{ref} / L_\mathrm{ref}`. For
single-species simulations with adiabatic electron/ion models, see
Appendix :ref:`sec_adiabatic-electron-ion-model-for-nprocs-1`.

.. _sec_normalized-equations:

Normalized equations
--------------------

We represent a dimensionless quantity by an overline, :math:`\bar f`, in this
section.
...
where we introduced
:math:`\bar{\lambda}_\mathrm{D}^2 = \frac{\lambda_\mathrm{D,ref}^2}{\rho_\mathrm{ref}^2} = \frac{\varepsilon_0 T_\mathrm{ref}/e_\mathrm{ref}^2n_\mathrm{ref}}{\rho_\mathrm{ref}^2}`
and
:math:`\bar{\beta} = \frac{\mu_0 n_\mathrm{ref} T_\mathrm{ref}}{B_\mathrm{ref}^2}`.
...
Normalized input parameters for GKV are summarized in Appendix :ref:`sec_list-of-gkv-namelist`.
