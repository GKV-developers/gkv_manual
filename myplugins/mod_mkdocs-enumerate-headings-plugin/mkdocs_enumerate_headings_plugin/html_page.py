...
class HTMLPage:
    def __init__(self, content: str, is_appendix=False) -> None:

        self.soup = BeautifulSoup(content, "html.parser")
        self.headings = self._find_headings()
        # for alphabetical chapter number in appendix
        for heading in self.headings:
            heading.is_appendix = is_appendix
    ...
    def set_page_chapter(self, chapter: list[int]) -> None:
