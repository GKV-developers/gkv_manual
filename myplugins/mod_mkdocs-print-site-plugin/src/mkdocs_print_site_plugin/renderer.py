...
class Renderer(object):
    ...
    def write_combined(self) -> Tuple[str, TableOfContents]:
        ...
        def get_html_and_anchor_links_from_items(
            ...
            for i, item in enumerate(items):
                ...
                if item.is_page:
                    ...
                    if item.file.src_path == mod_appendix_next_file:
                        is_appendix = True
                        appendix_offset = i + 1
                ...
                if item.is_section:
                    ...
                    section_html, section_links = get_html_and_anchor_links_from_items(
                        item.children, dir_urls, excluded_pages, mod_appendix_next_file, level + 1, my_prefix + ".", heading_styles
                    )
        ...
        items_html, anchor_links = get_html_and_anchor_links_from_items(
            ...
            mod_appendix_next_file=os.path.normpath(self.plugin_config.get("mod_appendix_next", "")),
